...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "Top-Left-Motor";
        FollowerConstants.leftRearMotorName = "Bottom-Left-Motor";
        FollowerConstants.rightFrontMotorName = "Top-Right-Motor";
        FollowerConstants.rightRearMotorName = "Bottom-Right-Motor";
